...
#package "mysql-server" do
#  action :install
#  notifies :create, "ruby_block[mysql-server_run_flag]", :immediately
#  not_if { node.attribute?("mysql-server_complete") }
#end

#ruby_block "mysql-server_run_flag" do
#  block do
#    node.set['mysql-server_complete'] = true
#    node.save
#  end
#  action :nothing
#end
